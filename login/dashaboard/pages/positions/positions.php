...
if ($result && $result->num_rows > 0) {
  ...
  $row = $result->fetch_assoc();
    ...
    <div class="recipe">The Reciper</div>
    <div class="linkto">To select positions</div>
    <?php
...
$sql = "SELECT pdf_file, id_sign,recipe_id
        FROM signs
        WHERE sender_id = (SELECT id FROM users WHERE username = '$username') and x=0 and y = 0";
...
$sql = "SELECT nom,prenom
        ...
        echo '<div class="linkto"><a href="detect.php?var=' . urlencode(    $idSign) . '">Click me</a></div>';
