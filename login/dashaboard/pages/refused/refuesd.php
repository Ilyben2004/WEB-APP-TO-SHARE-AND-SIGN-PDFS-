...
$sql = "SELECT pdf_file, id_sign,recipe_id
        FROM signs
        WHERE sender_id = (SELECT id FROM users WHERE username = '$username') and is_sign ='no'";
...
$sql = "SELECT nom,prenom
        ...
        echo '<div class="linkto"><a href="display/display.php?var=' . urlencode(    $idSign) . '">View The Pdf</a></div>';
