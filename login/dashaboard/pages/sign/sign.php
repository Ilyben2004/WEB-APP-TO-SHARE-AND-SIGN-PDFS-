...
if ($result && $result->num_rows > 0) {
  ...
  $row = $result->fetch_assoc();
   ...
   <div class="pdfname">PDF File Name</div>
    <div class="recipe">The Sender</div>
	...
	$sql = "SELECT pdf_file, id_sign,sender_id
    FROM signs
    WHERE recipe_id = (SELECT id FROM users WHERE username = '$username') and x<>0 and y <> 0 and is_sign is NULL";
...
$sql = "SELECT nom,prenom
    ...
    echo '<div class="linkto"><a href="insertSign/addsign.php?var=' . urlencode(    $idSign) . '">Sign Now</a></div>';
